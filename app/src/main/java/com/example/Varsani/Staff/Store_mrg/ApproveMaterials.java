...
public class ApproveMaterials extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txv_requestID.setText("Request No: "+in.getStringExtra("requestID"));
        edt_quotation.setText("Technician Name: "+in.getStringExtra("supplier"));
        txv_items.setText("Items: "+in.getStringExtra("item"));
        edt_expectedDate.setText("Requested On: "+in.getStringExtra("requestDate"));
        txv_requestStatus.setText("Status : "+in.getStringExtra("requestStatus"));
        txv_amount.setText("Serial: "+in.getStringExtra("amount"));
    ...
    public void alertApprove(){
        ...
        alertDialog.setMessage("You are About to Approve this Request");
