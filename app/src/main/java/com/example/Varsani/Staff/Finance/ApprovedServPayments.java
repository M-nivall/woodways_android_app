...
import static com.example.Varsani.utils.Urls.URL_APPROVED_SERV_PAYMENTS;

public class ApprovedServPayments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approved_serv_payments);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Approved Service Payments");
    ...
    public void newOrders(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPROVED_SERV_PAYMENTS,
