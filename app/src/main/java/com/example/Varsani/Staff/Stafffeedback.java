...
public class Stafffeedback extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stafffeedback);
    ...
    public void getFeedback(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Urls.UEL_STAFF_FEEDBACK,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                Toast.makeText(Stafffeedback.this, msg, Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                            }

                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(Stafffeedback.this, e.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Stafffeedback.this, error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void send(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Urls.UEL_STAFF_SEND_FEEDBACK,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
