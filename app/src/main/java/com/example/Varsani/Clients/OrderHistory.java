...
import com.example.Varsani.Clients.Adapters.AdapterOrderHistory;
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    OrderHistoryModal orderHistoryModel=new OrderHistoryModal(orderID,orderCost,mpesaCode,orderDate,orderStatus,shippingCost ,itemCost);
                                    list.add(orderHistoryModel);
                                }
                                adapterOrderHistory=new AdapterOrderHistory(getApplicationContext(),list);
