...
public class AdapterOrderHistory extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<OrderHistoryModal> items;
...
//    }
    ...
    public AdapterOrderHistory(Context context, List<OrderHistoryModal> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterOrderHistory.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterOrderHistory.OriginalViewHolder) {
            final AdapterOrderHistory.OriginalViewHolder view = (AdapterOrderHistory.OriginalViewHolder) holder;

            final OrderHistoryModal o= items.get(position);
            ...
            view.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent in=new Intent(ctx, ViewHistory.class);
