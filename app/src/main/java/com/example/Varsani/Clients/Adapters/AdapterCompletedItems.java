...
public class AdapterCompletedItems extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterCompletedItems(Context context, List<OrderItemModal> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lv_completed_items, parent, false);
