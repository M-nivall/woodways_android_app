...
public class AdapterFeedback extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView txv_comment,txv_reply,txv_recipient,txv_sender;
        ...
        public OriginalViewHolder(View v) {
            ...
            txv_sender =v.findViewById(R.id.txv_sender);
            txv_recipient =v.findViewById(R.id.txv_recipient);
            cardreply = v.findViewById(R.id.card_reply);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            if(p.getReply().equals("0")){
                ...
                view.cardreply.setVisibility(View.GONE);
            }else{
                view.txv_reply.setText(p.getReply());
                view.txv_recipient.setText(p.getRecipient());
                view.txv_sender.setText(p.getSender());
            }
        }
    }
    @Override
