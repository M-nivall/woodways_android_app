...
public class AdapterServiceCart extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lv_service_items, parent, false);
    ...
    public  void getAlertRemove(final View view) {
        ...
        builder1.setMessage("Are sure you want to cancel? ");
...
//                progressDialog.dismiss();
    ...
    public void removeItem(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Urls.URL_REMOVE_BOOKING,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try{
                            ...
                            if (status == 1){
                                ...
                                if (getItemCount() == 0){
                                    Toast.makeText(ctx, "Booking List Empty", Toast.LENGTH_SHORT).show();
